  ...
  head: () => ({
    meta: [
      ...
      { title: "Synkron | Keep Documentation in Sync With Every Code Commit" },
      {
        name: "description",
        content:
          "Synkron automatically updates your documentation whenever you push code. Stay synchronized, save development time, and let your team focus on building features instead of writing docs.",
      },
      { name: "author", content: "Synkron Team" },
      {
        name: "keywords",
        content:
          "documentation automation, GitHub integration, code documentation, developer tools, pull request automation, technical documentation",
      },
      { property: "og:title", content: "Synkron | Automated Documentation for Every Code Change" },
      {
        property: "og:description",
        content:
          "Keep your documentation perfectly in sync with every code commit. Synkron intelligently analyzes your changes and updates docs automatically.",
      },
      ...
      { name: "twitter:title", content: "Synkron | Automated Documentation Sync" },
      {
        ...
        content:
          "Stop writing documentation manually. Synkron keeps your docs in sync with your code automatically.",
      },
    ...
    links: [
      { rel: "canonical", href: "https://synkron.dev" },
      { rel: "preconnect", href: "https://fonts.googleapis.com" },
      { rel: "preconnect", href: "https://fonts.gstatic.com", crossOrigin: "anonymous" },
      {
        rel: "stylesheet",
        href: "https://fonts.googleapis.com/css2?family=Bricolage+Grotesque:opsz,wght@12..96,400;12..96,600;12..96,700;12..96,800&family=DM+Sans:opsz,wght@9..40,400;9..40,500;9..40,600&family=JetBrains+Mono:wght@400;500&display=swap",
      },
        ...
        <script
          ...
          dangerouslySetInnerHTML={{
            __html: JSON.stringify({
              ...
              name: "Synkron",
              description:
                "Keep your documentation in sync with every code commit. Synkron automatically updates docs when you push code.",
              url: "https://synkron.dev",
            ...
            __html: JSON.stringify({
              ...
              mainEntity: [
                ...
                },
                {
                  ...
                  acceptedAnswer: {
                    "@type": "Answer",
                    text: "Yes. Synkron uses Firebase for authentication and GitHub App installation tokens with minimal permissions: metadata: read, contents: write, and pull_requests: write. Your code stays in your repository and is never stored externally.",
                  },
                },
                {
                  "@type": "Question",
